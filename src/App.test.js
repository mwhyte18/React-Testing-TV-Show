...
import { render, waitForElement, wait, act } from "@testing-library/react";
...
//App, network tab, run fetch, click call that was made (missions in this), Preview is res.data only, go to response, copy paste to json-to-js.com get js version
